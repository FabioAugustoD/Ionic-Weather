...
class WeatherDataController {
    ...
    private apiKey: string = "62b94a15ef719ba690d3ada263cf6a6c";
    ...
    processData(data: WeatherResponse, unit: string) {
        ...
        unit).toFixed(1));
        data.main.temp_min = parseFloat(convertFromKelvin(data.main.temp_min,
        unit).toFixed(1));
        data.main.temp_max = parseFloat(convertFromKelvin(data.main.temp_max,
        unit).toFixed(1));
