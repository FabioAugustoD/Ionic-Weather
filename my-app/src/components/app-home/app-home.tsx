...
export class AppHome {
  ...
  // Once coordinates have been updating, get the weather
  try {
   this.weather = await WeatherData.getCurrentWeather();
  } catch (err) {
   console.log(err);
  }
  // Refresh the weather when returning from the settings page
  ...
  render() {
    return [
      ...
      <ion-content class="ion-padding">
        <ion-refresher hidden={true} slot="fixed" onIonRefresh={event =>
